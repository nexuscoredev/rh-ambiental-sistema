-- Cole no SQL Editor (produção) se ainda não aplicou a migration 20260602120000_nf_envio_contas_receber_time_t_desenvolvedor.sql
-- Permite Operacional (Time T) e Desenvolvedor gravar nf_enviada_em em contas_receber após envio/simulação.
-- O envio de e-mail em si exige deploy da Edge Function send-nf-email (não é SQL).
