-- Expõe `coletas.residuos_itens` na view de faturamento (pesagem estruturada).
...
COMMENT ON VIEW public.vw_faturamento_resumo IS
  'Faturamento / financeiro com esteira de medição, status de conferência e residuos_itens da pesagem.';
