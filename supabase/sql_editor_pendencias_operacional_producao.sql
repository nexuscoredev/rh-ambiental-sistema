-- =============================================================================
-- Pacote único — Controle de Massa / ticket (produção)
-- Cole TUDO no SQL Editor do Supabase e execute (Run).
-- Corrige:
--   • "Pesagem gravada, mas a coleta não foi atualizada no fluxo"
--   • RLS em tickets_operacionais ao gravar/imprimir ticket
-- (Não altera lógica de faturamento.)
-- =============================================================================

-- ---------- 1) Coleta após pesagem ----------
