...
export function FaltaConfiguracaoSupabase() {
  return (
    ...
    >
      ...
      >
        <h1 style={{ margin: "0 0 12px", fontSize: 22, color: "var(--text-primary, #0f172a)" }}>
          Falta o ficheiro de ambiente
        </h1>
        <p style={{ margin: "0 0 16px", color: "var(--text-secondary, #475569)", lineHeight: 1.55 }}>
          O cliente Supabase precisa de{" "}
          <code style={{ background: "var(--bg-inset, #f1f5f9)", padding: "2px 6px", borderRadius: 6 }}>
            VITE_SUPABASE_URL
          </code>{" "}
          e{" "}
          <code style={{ background: "var(--bg-inset, #f1f5f9)", padding: "2px 6px", borderRadius: 6 }}>
        ...
        <ol style={{ margin: "0 0 20px", paddingLeft: 22, color: "var(--text-primary, #334155)", lineHeight: 1.7 }}>
          <li>
