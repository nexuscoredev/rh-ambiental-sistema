    ...
    >
      ...
      >
        <div style={{ padding: '22px 22px 12px', borderBottom: '1px solid #f1f5f9' }}>
          ...
          <h2 id="rg-prompt-title" style={{ margin: 0, fontSize: '18px', fontWeight: 800, color: "var(--text-primary, #0f172a)" }}>
            {title}
          </h2>
          {message ? (
            <p style={{ margin: '10px 0 0', fontSize: '14px', color: "var(--text-primary, #334155)", lineHeight: 1.5 }}>{message}</p>
          ) : null}
        </div>
