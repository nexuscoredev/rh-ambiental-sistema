...
export function FaturamentoFilaAguardandoImpressao({ linhas, carregando }: Props) {
  ...
  return (
    <div style={wrap}>
      ...
      <p style={{ margin: '0 0 12px', fontSize: '13px', color: "var(--text-secondary, #475569)", lineHeight: 1.5 }}>
      ...
      <ul style={{ margin: 0, paddingLeft: '18px', fontSize: '13px', color: "var(--text-primary, #0f172a)", lineHeight: 1.55 }}>
