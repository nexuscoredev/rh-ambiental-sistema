...
export default function MTR() {
  ...
  async function loadData(opts?: LoadDataOptions) {
    ...
    if (pagina.error) {
      ...
      const paginaRows = pagina.rows

      if (!append && urlMtrId && !paginaRows.some((m) => m.id === urlMtrId)) {
        const extra = await fetchMtrListaPorId<MTR>(supabase, urlMtrId)
        mtrsRows = extra ? [extra, ...paginaRows] : paginaRows
      } else {
        mtrsRows = append ? [...mtrsRef.current, ...paginaRows] : paginaRows
      }
            ...
            <div className="panel-header">
              ...
              <div className="mtr-lista-filtros">
                <div className="mtr-lista-busca">
                  <label htmlFor="mtr-lista-busca-input-nexus" className="mtr-lista-busca__label">
                    Pesquisar
                  </label>
                  <input
                    id="mtr-lista-busca-input-nexus"
                    type="search"
                ...
                <div className="mtr-lista-busca mtr-lista-busca--lancador">
                  <label htmlFor="mtr-filtro-lancador-nexus" className="mtr-lista-busca__label">
                    Quem lançou
                  </label>
                  <select
                    id="mtr-filtro-lancador-nexus"
