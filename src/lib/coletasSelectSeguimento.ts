...
export const COLETAS_SELECT_CONTROLE_LISTA =
  'id, numero_coleta, numero, cliente, nome_cliente, tipo_residuo, residuo, residuo_catalogo_id, residuos_itens, placa, motorista, motorista_nome, status, status_processo, fluxo_status, etapa_operacional, peso_tara, peso_bruto, peso_liquido, mtr_id, programacao_id, cliente_id, data_execucao, data_agendada, created_at'
